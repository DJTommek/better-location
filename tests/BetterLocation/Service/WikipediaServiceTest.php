...
final class WikipediaServiceTest extends AbstractServiceTestCase
{
	...
	{
		$service = new WikipediaService($this->httpTestClients->mockedRequestor);
	...
	{
		$service = new WikipediaService($this->httpTestClients->realRequestor);
	...
	{
		$service = new WikipediaService($this->httpTestClients->offlineRequestor);
		$this->assertServiceLocation($service, $input, $expectedLat, $expectedLon);
	}
	 ...
	 */
	public function testNoLocationReal(string $input): void
	{
		$service = new WikipediaService($this->httpTestClients->realRequestor);
		$service->setInput($input);
	 ...
	 * @dataProvider noLocationProvider
	 */
	public function testNoLocationOffline(string $input): void
	{
		$service = new WikipediaService($this->httpTestClients->offlineRequestor);
		$service->setInput($input);
		$this->assertTrue($service->validate());
