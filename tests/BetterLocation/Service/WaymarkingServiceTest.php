...
final class WaymarkingServiceTest extends TestCase
{
	...
	{
		$this->assertTrue(WaymarkingService::validateStatic('https://www.waymarking.com/waymarks/WMDPMB_Erb_Leopolda_Laanskho_Moravsk_nm_Brno_Czech_Republic'));
		$this->assertTrue(WaymarkingService::validateStatic('https://waymarking.com/waymarks/WMDPMB_Erb_Leopolda_Laanskho_Moravsk_nm_Brno_Czech_Republic'));
		$this->assertTrue(WaymarkingService::validateStatic('http://WWW.waymarking.com/waymarks/WMDPMB_Erb_Leopolda_Laanskho_Moravsk_nm_Brno_Czech_Republic'));
		$this->assertTrue(WaymarkingService::validateStatic('http://waymarking.com/waymarks/WMDPMB_Erb_Leopolda_Laanskho_Moravsk_nm_Brno_Czech_Republic'));
		$this->assertTrue(WaymarkingService::validateStatic('https://www.waymarking.com/waymarks/WMDPMB_Erb_Leopolda_Laanskho_Moravsk_nm_Brno_Czech_Republic'));
		$this->assertTrue(WaymarkingService::validateStatic('https://www.waymarking.com/waymarks/WMDPMB'));

		$this->assertFalse(WaymarkingService::validateStatic('not valid url'));
		$this->assertFalse(WaymarkingService::validateStatic('https://www.waymarking.com'));
		$this->assertFalse(WaymarkingService::validateStatic('https://www.waymarking.com/waymarks/'));
		$this->assertFalse(WaymarkingService::validateStatic('https://www.waymarking.com/waymarks/AADPMB'));
	}

	public function testIsImageUrl(): void
	{
		$this->assertTrue(WaymarkingService::validateStatic('https://www.waymarking.com/gallery/image.aspx?f=1&guid=14f4cb4b-1c0a-4b35-834a-b42e6baf2816&gid=3'));
		$this->assertTrue(WaymarkingService::validateStatic('https://www.waymarking.com/gallery/image.aspx?f=1&guid=14f4cb4b-1c0a-4b35-834a-b42e6baf2816'));
	...
	{
		$this->assertTrue(WaymarkingService::validateStatic('https://www.waymarking.com/gallery/default.aspx?f=1&guid=9cc31753-8cfb-4b44-9c57-c2b303fd1a9b&gid=2'));
		$this->assertTrue(WaymarkingService::validateStatic('https://www.waymarking.com/gallery/default.aspx?f=1&guid=01645b8d-404c-41f1-a951-190032f55215&gid=2'));

		$this->assertFalse(WaymarkingService::validateStatic('not valid url'));
		$this->assertFalse(WaymarkingService::validateStatic('https://www.waymarking.com/gallery/default.aspx?f=1&guid=9cc31753-8cfb-4b44-9c57-c2b303fd1a9b'));
		$this->assertFalse(WaymarkingService::validateStatic('https://www.waymarking.com/gallery/default.aspx?f=1&guid=9cc31753-8cfb-4b44-9c57-c2b303fd1a9baaaaa&gid=2'));
		$this->assertFalse(WaymarkingService::validateStatic('https://www.waymarking.com/gallery/default.aspx?f=2&guid=9cc31753-8cfb-4b44-9c57-c2b303fd1a9b&gid=2'));
		$this->assertFalse(WaymarkingService::validateStatic('https://www.waymarking.com/gallery/default.aspx?f=1&guid=9cc31753-8cfb-4b44-9c57-c2b303fd1a9b&gid=3'));
	}
