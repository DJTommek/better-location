...
final class WGS84DegreesMinutesSecondsServiceTest extends TestCase
{
	...
	public function testCoordinates(): void
	{
		...
		$this->assertSame('43.642567,-79.387139', WGS84DegreesMinutesSecondsService::parseCoords('43°38\'33.24"N 79°23\'13.7"W')->__toString()); // same as above but already translited

		$this->assertSame('50.093653,14.412417', WGS84DegreesMinutesSecondsService::parseCoords('50°5\'37.15" 14°24\'44.70"')->__toString());
