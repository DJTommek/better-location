...
final class MapyCzServiceNewTest extends TestCase
{
	...
	public function testValidCoordinatesMapyCzId(): void
	{
		...
		$this->assertSame('48.873288,14.578971', MapyCzServiceNew::processStatic('https://en.mapy.cz/zemepisna?x=14.5702160&y=48.8734857&z=16&source=coor&id=14.57897074520588%2C48.87328807384455')->getFirst()->__toString());
		$this->assertSame('50.077886,14.371990', MapyCzServiceNew::processStatic('https://en.mapy.cz/zakladni?x=14.3985113&y=50.0696783&z=15&source=coor&id=14.371989590930184%2C50.07788610486586')->getFirst()->__toString());
		$this->assertSame('49.205899,14.257356', MapyCzServiceNew::processStatic('https://en.mapy.cz/textova?x=14.2573931&y=49.2063073&z=18&source=coor&id=14.257355545997598%2C49.205899024478754')->getFirst()->__toString()); // iQuest textova
		$this->assertSame('7.731071,-80.551001', MapyCzServiceNew::processStatic('https://en.mapy.cz/zakladni?x=-80.5308310&y=7.7192491&z=15&source=coor&id=-80.55100118168951%2C7.731071318967728')->getFirst()->__toString());
		$this->assertSame('65.608884,-168.088871', MapyCzServiceNew::processStatic('https://en.mapy.cz/zakladni?x=-168.0916515&y=65.6066015&z=15&source=coor&id=-168.08887063564356%2C65.60888429109842')->getFirst()->__toString());
		$this->assertSame('-1.138011,9.034823', MapyCzServiceNew::processStatic('https://en.mapy.cz/zakladni?x=8.9726814&y=-1.2094073&z=11&source=coor&id=9.034822831066833%2C-1.1380111329277875')->getFirst()->__toString());
	}

	public function testMapyCzXY(): void
	{
		$this->assertSame('50.069524,14.450824', MapyCzServiceNew::processStatic('https://en.mapy.cz/zakladni?x=14.4508239&y=50.0695244&z=15')->getFirst()->__toString());
		$this->assertSame('50.069524,14.450824', MapyCzServiceNew::processStatic('https://en.mapy.cz/zakladni?y=50.0695244&x=14.4508239&z=15')->getFirst()->__toString());
	}
	...
	{
		$collection = MapyCzServiceNew::processStatic('https://mapy.cz/s/cekahebefu')->getCollection();
		$this->assertCount(2, $collection);
		...
		$collection = MapyCzServiceNew::processStatic('https://en.mapy.cz/s/gacegelola')->getCollection(); // same as above just generated later by different user and on different IP and PC
		$this->assertCount(2, $collection);
		$this->assertSame('48.873288,14.578971', $collection[0]->__toString());
		$this->assertSame('Place coords', $collection[0]->getName());
		$this->assertSame('48.873486,14.570216', $collection[1]->__toString());
		...
		$collection = MapyCzServiceNew::processStatic('https://en.mapy.cz/s/bosafonabo')->getCollection();
		$this->assertCount(2, $collection);
		...
		$this->assertSame('7.731071,-80.551001', MapyCzServiceNew::processStatic('https://en.mapy.cz/s/godumokefu')->getFirst()->__toString());
		$this->assertSame('65.608884,-168.088871', MapyCzServiceNew::processStatic('https://en.mapy.cz/s/nopovehuhu')->getFirst()->__toString());
		$this->assertSame('-1.138011,9.034823', MapyCzServiceNew::processStatic('https://en.mapy.cz/s/lozohefobu')->getFirst()->__toString());
	}
	...
	public function testInvalidLatCoordinatesMapyCzId(): void
	{
		...
		$collection = MapyCzServiceNew::processStatic('https://en.mapy.cz/zakladni?x=14.3985113&y=50.0696783&z=15&source=coor&id=14.371989590930184%2C150.07788610486586')->getCollection();
		$this->assertCount(1, $collection);
		...
		$collection = MapyCzServiceNew::processStatic('https://en.mapy.cz/zakladni?x=14.3985113&y=50.0696783&z=15&source=coor&id=190.371989590930184%2C50.07788610486586')->getCollection();
		$this->assertCount(1, $collection);
		$this->assertSame('50.069678,14.398511', $collection[0]->__toString());
	}
	...
	{
		$this->assertSame('50.075959,15.016772', MapyCzServiceNew::processStatic('https://en.mapy.cz/zakladni?x=15.0162139&y=50.0820182&z=16&pano=1&pid=68059377&yaw=5.522&fov=1.257&pitch=0.101')->getFirst()->__toString());
		$this->assertSame('50.123351,16.284569', MapyCzServiceNew::processStatic('https://en.mapy.cz/turisticka?x=16.2845693&y=50.1233926&z=17&pano=1&source=base&id=2107710&pid=66437731&yaw=6.051&fov=1.257&pitch=0.157')->getFirst()->__toString()); // Viribus Unitis 2019
		$this->assertSame('50.094953,15.023081', MapyCzServiceNew::processStatic('https://en.mapy.cz/zakladni?x=15.0483153&y=50.1142203&z=15&pano=1&source=firm&id=216358&pid=68007689&yaw=3.985&fov=1.257&pitch=0.033')->getFirst()->__toString()); // Three different locations: map, place and panorama
		...
		$this->assertSame('50.078496,14.488369', MapyCzServiceNew::processStatic('https://en.mapy.cz/zakladni?x=14.4883693&y=50.0784958&z=15&pano=1&pid=70254688&yaw=0.424&fov=1.257&pitch=0.088')->getFirst()->__toString());
	}
	...
	{
		$collection = MapyCzServiceNew::processStatic('https://en.mapy.cz/zakladni?x=15.0162139&y=50.0820182&z=16&pano=1&pid=99999999999&yaw=5.522&fov=1.257&pitch=0.101')->getCollection();
		$this->assertCount(1, $collection);
		$this->assertSame('50.082018,15.016214', $collection[0]->__toString());

		$collection = MapyCzServiceNew::processStatic('https://en.mapy.cz/zakladni?pano=1&pid=99999999999&yaw=5.522&fov=1.257&pitch=0.101')->getCollection();
	...
	{
		$this->assertSame('50.073784,14.422105', MapyCzServiceNew::processStatic('https://en.mapy.cz/zakladni?x=14.4508239&y=50.0695244&z=15&source=base&id=2111676')->getFirst()->__toString());
		$this->assertSame('50.084007,14.440339', MapyCzServiceNew::processStatic('https://en.mapy.cz/zakladni?x=14.4527551&y=50.0750056&z=15&source=pubt&id=15308193')->getFirst()->__toString());
		$this->assertSame('50.084747,14.454012', MapyCzServiceNew::processStatic('https://mapy.cz/zakladni?x=14.4651576&y=50.0796325&z=15&source=firm&id=468797')->getFirst()->__toString());
		$this->assertSame('50.093312,14.455159', MapyCzServiceNew::processStatic('https://mapy.cz/zakladni?x=14.4367048&y=50.0943640&z=15&source=traf&id=15659817')->getFirst()->__toString());
		$this->assertSame('49.993611,14.205278', MapyCzServiceNew::processStatic('https://en.mapy.cz/fotografie?x=14.2029782&y=49.9929235&z=17&source=foto&id=1080344')->getFirst()->__toString());
		$this->assertSame('50.106624,14.366203', MapyCzServiceNew::processStatic('https://en.mapy.cz/zakladni?x=14.3596717&y=50.0997874&z=15&source=base&id=1833337')->getFirst()->__toString()); // area
		// some other places than Czechia (source OSM)
		$this->assertSame('49.444980,11.109055', MapyCzServiceNew::processStatic('https://en.mapy.cz/zakladni?x=11.0924687&y=49.4448356&z=15&source=osm&id=112448327')->getFirst()->__toString());
		// negative coordinates (source OSM)
		$this->assertSame('54.766918,-101.873729', MapyCzServiceNew::processStatic('https://en.mapy.cz/zakladni?x=-101.8754373&y=54.7693842&z=15&source=osm&id=1000536418')->getFirst()->__toString());
		$this->assertSame('-18.917167,47.535756', MapyCzServiceNew::processStatic('https://en.mapy.cz/zakladni?x=47.5323757&y=-18.9155159&z=16&source=osm&id=1040985945')->getFirst()->__toString());
		$this->assertSame('-45.870289,-67.507777', MapyCzServiceNew::processStatic('https://en.mapy.cz/zakladni?x=-67.5159386&y=-45.8711989&z=15&source=osm&id=17164289')->getFirst()->__toString());
	}
	...
	{
		$this->assertSame('50.533111,16.155906', MapyCzServiceNew::processStatic('https://en.mapy.cz/s/devevemoje')->getFirst()->__toString());
		$this->assertSame('50.084007,14.440339', MapyCzServiceNew::processStatic('https://en.mapy.cz/s/degogalazo')->getFirst()->__toString());
		$this->assertSame('50.084747,14.454012', MapyCzServiceNew::processStatic('https://en.mapy.cz/s/cavukepuba')->getFirst()->__toString());
		$this->assertSame('50.093312,14.455159', MapyCzServiceNew::processStatic('https://en.mapy.cz/s/fuvatavode')->getFirst()->__toString());
		$this->assertSame('50.106624,14.366203', MapyCzServiceNew::processStatic('https://en.mapy.cz/s/gesaperote')->getFirst()->__toString()); // area
		// some other places than Czechia (source OSM)
		$this->assertSame('49.444980,11.109055', MapyCzServiceNew::processStatic('https://en.mapy.cz/s/hozogeruvo')->getFirst()->__toString());
		// negative coordinates (source OSM)
		$this->assertSame('54.766918,-101.873729', MapyCzServiceNew::processStatic('https://en.mapy.cz/s/dasorekeja')->getFirst()->__toString());
//			$this->assertSame('-18.917167,47.535756', MapyCzServiceNew::processStatic('https://en.mapy.cz/s/maposedeso')->getFirst()->__toString());
		$this->assertSame('-18.917167,47.535756', MapyCzServiceNew::processStatic('https://en.mapy.cz/s/maposedeso')->getFirst()->__toString());
		$this->assertSame('-45.870289,-67.507777', MapyCzServiceNew::processStatic('https://en.mapy.cz/s/robelevuja')->getFirst()->__toString());
	}
	...
	{
		$collection = MapyCzServiceNew::processStatic('https://en.mapy.cz/zakladni?x=14.4508239&y=50.0695244&z=15&source=base&id=1234')->getCollection();
		$this->assertCount(1, $collection);
		$this->assertSame('50.069524,14.450824', $collection[0]->__toString());
		$this->assertSame('Map center', $collection[0]->getName());

		$collection = MapyCzServiceNew::processStatic('https://en.mapy.cz/zakladni?source=base&id=1234')->getCollection();
		$this->assertCount(0, $collection);
		...
		$collection = MapyCzServiceNew::processStatic('https://en.mapy.cz/zakladni?x=14.4508239&y=50.0695244&z=15&source=base&id=2111676a')->getCollection();
		$this->assertCount(1, $collection);
		$this->assertSame('50.069524,14.450824', $collection[0]->__toString());
		$this->assertSame('Map center', $collection[0]->getName());
	}
	...
	{
		$collection = MapyCzServiceNew::processStatic('https://en.mapy.cz/zakladni?x=14.4508239&y=50.0695244&source=coor&id=14.4508239,50.0695244aaa&z=15')->getCollection();
		$this->assertCount(1, $collection);
		$this->assertSame('50.069524,14.450824', $collection[0]->__toString());
		$this->assertSame('Map center', $collection[0]->getName());
	}
	...
	public function testInvalidPlaceCoordinates2(): void
	{
		...
		MapyCzServiceNew::processStatic('https://en.mapy.cz/zakladni?source=coor&id=14.4508239,50.0695244aaa&z=15')->getCollection();
	}
}
