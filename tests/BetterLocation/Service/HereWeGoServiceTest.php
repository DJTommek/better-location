...
final class HereWeGoServiceTest extends TestCase
{
	...
	{
		$this->assertSame('50.075130,14.454530', HereWeGoService::parseCoordsMultiple('https://wego.here.com/?map=50.07513,14.45453,15,normal')[0]->__toString()); // browser

		$this->assertSame('50.086290,14.428080', HereWeGoService::parseCoordsMultiple('https://wego.here.com/?x=ep&map=50.08629,14.42808,15,satellite_traffic')[0]->__toString());

		$this->assertSame('50.052150,14.452560', HereWeGoService::parseCoordsMultiple('https://share.here.com/l/50.05215,14.45256,Ohradn%C3%AD?z=16&t=normal&ref=android')[0]->__toString());
		...
		$this->assertSame('-18.895111,47.516448', $locations[0]->__toString());
		$this->assertSame('-18.895110,47.516450', $locations[1]->__toString());
		...
		$this->assertSame('50.088043,14.418300', $locations[0]->__toString());
		$this->assertSame('50.088290,14.417790', $locations[1]->__toString());
		...
		$this->assertSame('50.088183,14.415371', $location[0]->__toString());
		$this->assertSame('50.088180,14.415370', $location[1]->__toString());
		...
		$this->assertSame('-15.805571,-47.889866', $location[0]->__toString());
		$this->assertSame('-15.805570,-47.889870', $location[1]->__toString());
	...
	public function testStartPointUrl(): void
	{
		...
		$this->assertSame('-15.951040,-5.677430', $location[0]->__toString());
		$this->assertSame('-15.950800,-5.679040', $location[1]->__toString());
	}
	...
	public function testRequestLocUrl(): void
	{
		...
		$this->assertSame('50.089340,14.413640', $location[0]->__toString());
		$this->assertSame('50.089630,14.412760', $location[1]->__toString());
		...
		$this->assertSame('50.105540,14.475900', $location[0]->__toString());
		$this->assertSame('50.105540,14.475900', $location[1]->__toString());
		...
		$this->assertSame('-15.978160,-5.712050', $location[0]->__toString());
		$this->assertSame('-15.994290,-5.756810', $location[1]->__toString());
	}
	...
	public function testShortUrl(): void
	{
		...
		$this->assertSame('50.109570,14.441220', $location[0]->__toString());
		...
		$this->assertSame('50.096670,14.445130', $location[0]->__toString());
	}
