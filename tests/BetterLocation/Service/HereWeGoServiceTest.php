...
final class HereWeGoServiceTest extends TestCase
{
	...
	{
		$this->assertTrue(HereWeGoService::validateStatic('https://wego.here.com/?map=50.07513,14.45453,15,normal')); // browser
		$this->assertTrue(HereWeGoService::validateStatic('https://wego.here.com/?x=ep&map=50.08629,14.42808,15,satellite_traffic'));
		$this->assertTrue(HereWeGoService::validateStatic('https://share.here.com/l/50.05215,14.45256,Ohradn%C3%AD?z=16&t=normal&ref=android'));
		$this->assertTrue(HereWeGoService::validateStatic('https://wego.here.com/public-transport/Station%2520des%2520Bus%2520Ankazomanga/-18.895111/47.516448?map=-18.89511,47.51645,16,normal'));
		$this->assertTrue(HereWeGoService::validateStatic('https://wego.here.com/%C4%8Desk%C3%A1-republika/praha/public-transport/staromestska/50.088043/14.4183?map=50.08829,14.41779,17,satellite_traffic'));
		$this->assertTrue(HereWeGoService::validateStatic('https://wego.here.com/public-transport/Staromestska/50.088183/14.415371?map=50.08818,14.41537,17,normal'));  // browser, selected place before redirect
		$this->assertTrue(HereWeGoService::validateStatic('https://wego.here.com/%C4%8Desk%C3%A1-republika/praha/public-transport/staromestska/50.088183/14.415371?map=50.08818,14.41537,17,normal'));  // browser, selected place after redirect from URL above
		$this->assertTrue(HereWeGoService::validateStatic('https://wego.here.com/public-transport/Esta%25C3%25A7%25C3%25A3o%2520102%2520Sul%2520Metro/-15.805571/-47.889866?map=-15.80557,-47.88987,16,terrain'));  // browser, selected place before redirect
		$this->assertTrue(HereWeGoService::validateStatic('https://wego.here.com/brasil/bras%C3%ADlia/public-transport/esta%C3%A7%C3%A3o-102-sul-metro/-15.805571/-47.889866?map=-15.80557,-47.88987,16,terrain'));  // browser, selected place after redirect from URL above
	}
	...
	{
		$this->assertTrue(HereWeGoService::validateStatic('https://wego.here.com/directions/mix/Bottomwoods,-Longwood,-Saint-Helena:-15.95104,-5.67743/?map=-15.9508,-5.67904,18,terrain&msg=Bottomwoods'));
	}
	...
	public function testIsValidRequestLocUrl(): void
	{
		...
		$this->assertTrue(HereWeGoService::validateStatic('https://wego.here.com/saint-helena/sandy-bay/city-town-village/sandy-bay--loc-dmVyc2lvbj0xO3RpdGxlPVNhbmR5K0JheTtsYXQ9LTE1Ljk3ODE2O2xvbj0tNS43MTIwNTtjaXR5PVNhbmR5K0JheTtjb3VudHJ5PVNITjtjb3VudHk9U2FuZHkrQmF5O2NhdGVnb3J5SWQ9Y2l0eS10b3duLXZpbGxhZ2U7c291cmNlU3lzdGVtPWludGVybmFs?map=-15.99429,-5.75681,15,normal&msg=Sandy%20Bay'));
	}
	...
	{
		$this->assertTrue(HereWeGoService::validateStatic('https://her.is/3lZVXD3'));
		$this->assertTrue(HereWeGoService::validateStatic('https://her.is/3bEopFZ'));
	}
	...
	{
		$this->assertFalse(HereWeGoService::validateStatic('Novinky.cz'));
	}
}
